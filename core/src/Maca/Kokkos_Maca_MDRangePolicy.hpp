...
*  FileName : Kokkos_Maca_MDRangePolicy.hpp
*  Author   : jwwang2003
*  Email    : wjw_03@outlook.com
*  Date     : Fri 17 Apr 2026 10:48:27 AM CST
================================================================*/

// SPDX-License-Identifier: Apache-2.0 WITH LLVM-exception
// SPDX-FileCopyrightText: Copyright Contributors to the Kokkos project

#ifndef KOKKOS_MACA_MDRANGEPOLICY_HPP_
#define KOKKOS_MACA_MDRANGEPOLICY_HPP_
...
template <>
struct default_outer_direction<Maca> {
  using type                     = Iterate;
  static constexpr Iterate value = Iterate::Left;
};

template <>
struct default_inner_direction<Maca> {
  using type                     = Iterate;
  static constexpr Iterate value = Iterate::Left;
};
...
template <>
struct TileSizeRecommended<Kokkos::Maca> {
...
template <>
inline TileSizeProperties get_tile_size_properties<Maca>(const Maca& space) {
  TileSizeProperties properties;
  const auto& device_prop              = space.maca_device_prop();
  properties.max_threads               = device_prop.maxThreadsPerBlock;
  properties.max_total_tile_size       = MacaTraits::MaxThreadsPerBlock;
...
struct ThreadAndVectorNestLevel<Rank, Maca, ThreadAndVector>
