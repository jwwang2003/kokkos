...
*  FileName : Kokkos_Maca_ParallelReduce_MDRange.hpp
*  Author   : jwwang2003
...
#ifndef KOKKOS_MACA_PARALLEL_REDUCE_MDRANGE_HPP
#define KOKKOS_MACA_PARALLEL_REDUCE_MDRANGE_HPP
...
class ParallelReduce<CombinedFunctorReducerType,
                     Kokkos::MDRangePolicy<Traits...>, Maca> {
 public:
 ...
 public:
  ...
  inline __device__ void operator()() const {
    ...
    if (::Kokkos::Impl::maca_single_inter_block_reduce_scan<false>(
      ...
      if (Impl::MacaTraits::WarpSize < word_count.value) {
        __syncthreads();
      }
  ...
  // This is copy/paste from Kokkos_Maca_Parallel_Range
