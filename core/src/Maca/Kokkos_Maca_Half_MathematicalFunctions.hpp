...
#define KOKKOS_MACA_HALF_UNARY_FUNCTION(OP, HIP_NAME, HALF_TYPE) \
  KOKKOS_INLINE_FUNCTION HALF_TYPE impl_##OP(HALF_TYPE x) {     \
    return HIP_NAME(HALF_TYPE::impl_type(x));                   \
  }

#define KOKKOS_MACA_HALF_BINARY_FUNCTION(OP, HIP_NAME, HALF_TYPE)         \
...
#define KOKKOS_MACA_HALF_UNARY_PREDICATE(OP, HIP_NAME, HALF_TYPE) \
  KOKKOS_INLINE_FUNCTION bool impl_##OP(HALF_TYPE x) {           \
    return HIP_NAME(HALF_TYPE::impl_type(x));                    \
  }

#define KOKKOS_MACA_HALF_UNARY_FUNCTION_IMPL(OP, HIP_NAME) \
  KOKKOS_MACA_HALF_UNARY_FUNCTION(OP, HIP_NAME, Kokkos::Experimental::half_t)
#define KOKKOS_MACA_HALF_BINARY_FUNCTION_IMPL(OP, HIP_NAME) \
  KOKKOS_MACA_HALF_BINARY_FUNCTION(OP, HIP_NAME, Kokkos::Experimental::half_t)
#define KOKKOS_MACA_HALF_UNARY_PREDICATE_IMPL(OP, HIP_NAME) \
  KOKKOS_MACA_HALF_UNARY_PREDICATE(OP, HIP_NAME, Kokkos::Experimental::half_t)
...
#define KOKKOS_MACA_BHALF_UNARY_FUNCTION_IMPL(OP, HIP_NAME) \
  KOKKOS_MACA_HALF_UNARY_FUNCTION(OP, HIP_NAME, Kokkos::Experimental::bhalf_t)
#define KOKKOS_MACA_BHALF_BINARY_FUNCTION_IMPL(OP, HIP_NAME) \
  KOKKOS_MACA_HALF_BINARY_FUNCTION(OP, HIP_NAME, Kokkos::Experimental::bhalf_t)
#define KOKKOS_MACA_BHALF_UNARY_PREDICATE_IMPL(OP, HIP_NAME) \
  KOKKOS_MACA_HALF_UNARY_PREDICATE(OP, HIP_NAME, Kokkos::Experimental::bhalf_t)
...
#define KOKKOS_MACA_HALF_AND_BHALF_UNARY_FUNCTION_IMPL(OP, HIP_NAME) \
  KOKKOS_MACA_HALF_UNARY_FUNCTION_IMPL(OP, HIP_NAME)                 \
  KOKKOS_MACA_BHALF_UNARY_FUNCTION_IMPL(OP, HIP_NAME)

#define KOKKOS_MACA_HALF_AND_BHALF_BINARY_FUNCTION_IMPL(OP, HIP_NAME) \
  KOKKOS_MACA_HALF_BINARY_FUNCTION_IMPL(OP, HIP_NAME)                 \
  KOKKOS_MACA_BHALF_BINARY_FUNCTION_IMPL(OP, HIP_NAME)

#define KOKKOS_MACA_HALF_AND_BHALF_UNARY_PREDICATE_IMPL(OP, HIP_NAME) \
  KOKKOS_MACA_HALF_UNARY_PREDICATE_IMPL(OP, HIP_NAME)                 \
  KOKKOS_MACA_BHALF_UNARY_PREDICATE_IMPL(OP, HIP_NAME)
