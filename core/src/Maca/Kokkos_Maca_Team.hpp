...
#ifndef KOKKOS_MACA_TEAM_HPP
#define KOKKOS_MACA_TEAM_HPP
 ...
 *
 *  Maca thread blocks for team closures are dimensioned as:
 ...
 */
class MacaTeamMember {
 public:
  using execution_space      = Maca;
  using scratch_memory_space = execution_space::scratch_memory_space;
  using team_handle          = MacaTeamMember;
 ...
 public:
   ...
   *    blockDim.x <= MacaTraits::WarpSize
   *    ( 0 == MacaTraits::WarpSize % ( blockDim.x * blockDim.y )
   *      OR
   *    ( 1 == blockDim.z )
   */
  ...
  KOKKOS_INLINE_FUNCTION
  MacaTeamMember(void* shared, const size_t shared_begin,
...
struct TeamThreadRangeBoundariesStruct<iType, MacaTeamMember> {
  using index_type = iType;
  const MacaTeamMember& member;
  const iType start;
  const iType end;

  KOKKOS_INLINE_FUNCTION
  TeamThreadRangeBoundariesStruct(const MacaTeamMember& arg_thread,
                                  iType arg_count)
...
template <typename iType>
struct TeamVectorRangeBoundariesStruct<iType, MacaTeamMember> {
  using index_type = iType;
  const MacaTeamMember& member;
  const iType start;
  const iType end;
  ...
  KOKKOS_INLINE_FUNCTION
  TeamVectorRangeBoundariesStruct(const MacaTeamMember& arg_thread,
...
template <typename iType>
struct ThreadVectorRangeBoundariesStruct<iType, MacaTeamMember> {
  using index_type = iType;
  const index_type start;
  const index_type end;

  KOKKOS_INLINE_FUNCTION
  ThreadVectorRangeBoundariesStruct(const MacaTeamMember, index_type arg_count)
      : start(static_cast<index_type>(0)), end(arg_count) {}

  KOKKOS_INLINE_FUNCTION
  ThreadVectorRangeBoundariesStruct(const MacaTeamMember, index_type arg_begin,
                                    index_type arg_end)
...
template <typename iType>
KOKKOS_INLINE_FUNCTION
    Impl::TeamThreadRangeBoundariesStruct<iType, Impl::MacaTeamMember>
    TeamThreadRange(const Impl::MacaTeamMember& thread, iType count) {
  return Impl::TeamThreadRangeBoundariesStruct<iType, Impl::MacaTeamMember>(
      thread, count);
}

template <typename iType1, typename iType2>
KOKKOS_INLINE_FUNCTION Impl::TeamThreadRangeBoundariesStruct<
    std::common_type_t<iType1, iType2>, Impl::MacaTeamMember>
TeamThreadRange(const Impl::MacaTeamMember& thread, iType1 begin, iType2 end) {
...
template <typename iType>
KOKKOS_INLINE_FUNCTION
    Impl::TeamVectorRangeBoundariesStruct<iType, Impl::MacaTeamMember>
    TeamVectorRange(const Impl::MacaTeamMember& thread, const iType& count) {
  return Impl::TeamVectorRangeBoundariesStruct<iType, Impl::MacaTeamMember>(
      thread, count);
}
...
KOKKOS_INLINE_FUNCTION Impl::TeamVectorRangeBoundariesStruct<
    std::common_type_t<iType1, iType2>, Impl::MacaTeamMember>
TeamVectorRange(const Impl::MacaTeamMember& thread, const iType1& begin,
                const iType2& end) {
  using iType = std::common_type_t<iType1, iType2>;
  return Impl::TeamVectorRangeBoundariesStruct<iType, Impl::MacaTeamMember>(
      thread, iType(begin), iType(end));
...
template <typename iType>
KOKKOS_INLINE_FUNCTION
    Impl::ThreadVectorRangeBoundariesStruct<iType, Impl::MacaTeamMember>
    ThreadVectorRange(const Impl::MacaTeamMember& thread, iType count) {
  return Impl::ThreadVectorRangeBoundariesStruct<iType, Impl::MacaTeamMember>(
      thread, count);
}
...
KOKKOS_INLINE_FUNCTION Impl::ThreadVectorRangeBoundariesStruct<
    std::common_type_t<iType1, iType2>, Impl::MacaTeamMember>
ThreadVectorRange(const Impl::MacaTeamMember& thread, iType1 arg_begin,
                  iType2 arg_end) {
  using iType = std::common_type_t<iType1, iType2>;
  return Impl::ThreadVectorRangeBoundariesStruct<iType, Impl::MacaTeamMember>(
...
KOKKOS_INLINE_FUNCTION
Impl::ThreadSingleStruct<Impl::MacaTeamMember> PerTeam(
    const Impl::MacaTeamMember& thread) {
  return Impl::ThreadSingleStruct<Impl::MacaTeamMember>(thread);
}

KOKKOS_INLINE_FUNCTION
Impl::VectorSingleStruct<Impl::MacaTeamMember> PerThread(
    const Impl::MacaTeamMember& thread) {
  return Impl::VectorSingleStruct<Impl::MacaTeamMember>(thread);
}
...
parallel_reduce(const Impl::TeamThreadRangeBoundariesStruct<
  ...
  using functor_analysis_type = typename Impl::FunctorAnalysis<
      ...
      TeamPolicy<typename Impl::MacaTeamMember::execution_space>, ReducerType,
      value_type>;
...
parallel_reduce(const Impl::TeamThreadRangeBoundariesStruct<
  ...
  KOKKOS_IF_ON_DEVICE(
      (using functor_analysis_type = typename Impl::FunctorAnalysis<
           Impl::FunctorPatternInterface::REDUCE,
           TeamPolicy<typename Impl::MacaTeamMember::execution_space>, Closure,
           ValueType>;
       using wrapped_reducer_type = typename functor_analysis_type::Reducer;
...
parallel_reduce(Impl::ThreadVectorRangeBoundariesStruct<
  ...
  Impl::MacaTeamMember::impl_vector_reduce(wrapped_reducer, value);
...
parallel_scan(const Impl::ThreadVectorRangeBoundariesStruct<
  ...
  //   1 <= blockDim.x <= MacaTraits::WarpSize
  ...
  for (int i = threadIdx.x; i < end; i += blockDim.x) {
    ...
    // where each Maca thread is the root of a reduction tree
