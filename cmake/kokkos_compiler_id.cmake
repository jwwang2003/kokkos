...
if(Kokkos_ENABLE_MACA)
  ...
  string(FIND ${INTERNAL_COMPILER_VERSION_ONE_LINE} "mxcc" INTERNAL_COMPILER_VERSION_CONTAINS_MXCC)
  if(INTERNAL_COMPILER_VERSION_CONTAINS_MXCC GREATER -1)
    set(KOKKOS_CXX_COMPILER_ID MXCC)
  endif()
...
elseif(KOKKOS_CXX_COMPILER_ID STREQUAL MXCC)
  if(KOKKOS_CXX_COMPILER_VERSION VERSION_LESS ${KOKKOS_MXCC_MINIMUM})
    message(FATAL_ERROR "${KOKKOS_MESSAGE_TEXT}")
  endif()
