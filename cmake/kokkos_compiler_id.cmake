...
set(KOKKOS_IMPL_CU_BRIDGE OFF)

if(Kokkos_ENABLE_CUDA)
  if(DEFINED ENV{CUCC_PATH})
    set(KOKKOS_IMPL_CU_BRIDGE ON)
  elseif(DEFINED CMAKE_CUDA_COMPILER
         AND (CMAKE_CUDA_COMPILER MATCHES "cu-bridge" OR CMAKE_CUDA_COMPILER MATCHES "/CUDA_DIR/bin/nvcc$")
  )
    set(KOKKOS_IMPL_CU_BRIDGE ON)
  elseif(CMAKE_CXX_COMPILER MATCHES "cu-bridge")
    set(KOKKOS_IMPL_CU_BRIDGE ON)
  endif()
endif()

if(KOKKOS_IMPL_CU_BRIDGE)
  global_append(KOKKOS_COMPILE_DEFINITIONS KOKKOS_IMPL_CU_BRIDGE)
endif()
...
macro(kokkos_internal_have_compiler_nvcc)
  ...
  string(FIND ${INTERNAL_COMPILER_VERSION_ONE_LINE} "mxcc version" INTERNAL_COMPILER_VERSION_CONTAINS_MXCC)
  ...
  if(${INTERNAL_COMPILER_VERSION_CONTAINS_NVCC} GREATER -1
     OR (KOKKOS_IMPL_CU_BRIDGE AND ${INTERNAL_COMPILER_VERSION_CONTAINS_MXCC} GREATER -1)
  )
...
if(INTERNAL_HAVE_COMPILER_NVCC)
  ...
  elseif(KOKKOS_IMPL_CU_BRIDGE)
    set(KOKKOS_CXX_COMPILER_VERSION 11.6.55)
  endif()
...
set(KOKKOS_NVCC_CU_BRIDGE_MINIMUM 11.6.0)
set(KOKKOS_HIPCC_MINIMUM 6.2.0)
set(KOKKOS_NVHPC_MINIMUM 22.3)
set(KOKKOS_MSVC_MINIMUM 19.30)
set(KOKKOS_NVCC_EFFECTIVE_MINIMUM ${KOKKOS_NVCC_MINIMUM})

if(KOKKOS_IMPL_CU_BRIDGE)
  set(KOKKOS_NVCC_EFFECTIVE_MINIMUM ${KOKKOS_NVCC_CU_BRIDGE_MINIMUM})
  message(
    STATUS
      "Detected cu-bridge-compatible CUDA toolchain; accepting reported NVIDIA compiler version ${KOKKOS_CXX_COMPILER_VERSION} with minimum ${KOKKOS_NVCC_EFFECTIVE_MINIMUM}"
  )
endif()
...
set(KOKKOS_MESSAGE_TEXT "${KOKKOS_MESSAGE_TEXT}\n    NVCC                ${KOKKOS_NVCC_EFFECTIVE_MINIMUM}")
...
elseif(KOKKOS_CXX_COMPILER_ID STREQUAL NVIDIA)
  if(KOKKOS_CXX_COMPILER_VERSION VERSION_LESS ${KOKKOS_NVCC_EFFECTIVE_MINIMUM})
    message(FATAL_ERROR "${KOKKOS_MESSAGE_TEXT}")
  endif()
